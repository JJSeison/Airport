...
public class AirportFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        scrollPaneMyFlights.setViewportView(jTable1);
        ...
        scrollPaneAllPassengers.setViewportView(jTable2);
        ...
        scrollPaneAllFlights.setViewportView(jTable3);
        ...
        scrollPaneAllPlanes.setViewportView(jTable4);
        ...
        scrollPaneAllLocations.setViewportView(jTable5);
    ...
    private void radioUserTypeAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioUserTypeAdminActionPerformed
    ...
    }//GEN-LAST:event_radioUserTypeAdminActionPerformed

    private void radioUserTypeUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioUserTypeUserActionPerformed
    ...
    }//GEN-LAST:event_radioUserTypeUserActionPerformed
    ...
    private void btnRegisterPassengerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterPassengerActionPerformed
        ...
        int month = Integer.parseInt(comboPassengerBirthMonth.getItemAt(comboPassengerBirthMonth.getSelectedIndex()));
        int day = Integer.parseInt(comboPassengerBirthDay.getItemAt(comboPassengerBirthDay.getSelectedIndex()));
        ...
        this.comboSelectUser.addItem("" + id);
    ...
    private void btnCreateLocationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateLocationActionPerformed
        // TODO add your handling code here:
        String id = txtLocationAirportId.getText();
        String name = txtLocationAirportName.getText();
        String city = txtLocationAirportCity.getText();
        String country = txtLocationAirportCountry.getText();
        double latitude = Double.parseDouble(txtLocationAirportLatitude.getText());
        double longitude = Double.parseDouble(txtLocationAirportLongitude.getText());

        this.locations.add(new Location(id, name, city, country, latitude, longitude));

        this.comboFlightDepartureLocation.addItem(id);
        this.comboFlightArrivalLocation.addItem(id);
        this.comboFlightScaleLocation.addItem(id);
    ...
    private void btnCreateFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateFlightActionPerformed
        ...
        String planeId = comboFlightPlane.getItemAt(comboFlightPlane.getSelectedIndex());
        String departureLocationId = comboFlightDepartureLocation.getItemAt(comboFlightDepartureLocation.getSelectedIndex());
        String arrivalLocationId = comboFlightArrivalLocation.getItemAt(comboFlightArrivalLocation.getSelectedIndex());
        String scaleLocationId = comboFlightScaleLocation.getItemAt(comboFlightScaleLocation.getSelectedIndex());
        int year = Integer.parseInt(txtFlightDepartureYear.getText());
        int month = Integer.parseInt(comboFlightDepartureMonth.getItemAt(comboFlightDepartureMonth.getSelectedIndex()));
        int day = Integer.parseInt(comboFlightDepartureDay.getItemAt(comboFlightDepartureDay.getSelectedIndex()));
        int hour = Integer.parseInt(comboFlightDepartureHour.getItemAt(comboFlightDepartureHour.getSelectedIndex()));
        int minutes = Integer.parseInt(comboFlightDepartureMinute.getItemAt(comboFlightDepartureMinute.getSelectedIndex()));
        int hoursDurationsArrival = Integer.parseInt(comboFlightArrivalDurationHour.getItemAt(comboFlightArrivalDurationHour.getSelectedIndex()));
        int minutesDurationsArrival = Integer.parseInt(comboFlightArrivalDurationMinute.getItemAt(comboFlightArrivalDurationMinute.getSelectedIndex()));
        int hoursDurationsScale = Integer.parseInt(comboFlightScaleDurationHour.getItemAt(comboFlightScaleDurationHour.getSelectedIndex()));
        int minutesDurationsScale = Integer.parseInt(comboFlightScaleDurationMinute.getItemAt(comboFlightScaleDurationMinute.getSelectedIndex()));
        ...
        this.comboFlight_AddToFlight.addItem(id);
    ...
    private void btnUpdatePassengerInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdatePassengerInfoActionPerformed
        ...
        String firstname = txtUpdatePassengerFirstName.getText();
        String lastname = txtUpdatePassengerLastName.getText();
        int year = Integer.parseInt(txtUpdatePassengerBirthYear.getText());
        int month = Integer.parseInt(comboPassengerBirthMonth.getItemAt(comboUpdatePassengerBirthMonth.getSelectedIndex()));
        int day = Integer.parseInt(comboPassengerBirthDay.getItemAt(comboUpdatePassengerBirthDay.getSelectedIndex()));
        int phoneCode = Integer.parseInt(txtUpdatePassengerPhoneCode.getText());
        long phone = Long.parseLong(txtUpdatePassengerPhoneNumber.getText());
        String country = txtUpdatePassengerCountry.getText();
    ...
    private void btnAddPassengerToFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPassengerToFlightActionPerformed
        // TODO add your handling code here:
        long passengerId = Long.parseLong(txtPassengerId_AddToFlight.getText());
        String flightId = comboFlight_AddToFlight.getItemAt(comboFlight_AddToFlight.getSelectedIndex());
    ...
    private void btnDelayFlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelayFlightActionPerformed
        // TODO add your handling code here:
        String flightId = comboFlightId_DelayFlight.getItemAt(comboFlightId_DelayFlight.getSelectedIndex());
        int hours = Integer.parseInt(comboDelayFlightHours.getItemAt(comboDelayFlightHours.getSelectedIndex()));
        int minutes = Integer.parseInt(comboDelayFlightMinutes.getItemAt(comboDelayFlightMinutes.getSelectedIndex()));
    ...
    private void btnRefreshMyFlightsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshMyFlightsActionPerformed
        // TODO add your handling code here:
        long passengerId = Long.parseLong(comboSelectUser.getItemAt(comboSelectUser.getSelectedIndex()));
    ...
    private void btnRefreshAllPassengersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshAllPassengersActionPerformed
        // TODO add your handling code here:
    ...
    private void comboSelectUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboSelectUserActionPerformed
        try {
            ...
            if (! id.equals(comboSelectUser.getItemAt(0))) {
